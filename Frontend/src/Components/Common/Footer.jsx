    ...
    return (
        <footer className='border-t py-12'>
            <div className='container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 px-4 lg:px-0'>
                <div className=''>
                    <h3 className='text-lg text-gray-800 mb-4'> Newsletter
                    </h3>
                    <p className='text-gray-500 mb-4'>Be the first to hear about new products,exclusive events,and online offer </p>
                ...
                <div>
                    ...
                    <p>
                        <FiPhoneCall className='inline-block mr-4' />
                        0123-456-789
                    </p>
                </div>
            </div>
            {/* footer bottom */}
            <div className='containermx-auto mt-12 px-4 lg:px-0 border-t border-gray-200 pt-6'></div>
            <p className='text-gray-500 text-sm tracking-tighter text-center'>@ 2025,CompileTap.All Rights Reserved.</p>
        </footer>
    );
};
