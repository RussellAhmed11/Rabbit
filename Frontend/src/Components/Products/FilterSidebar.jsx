...
const FilterSidebar = () => {
    ...
    const colors = [
        "Red", "Blue", "Green", "Yellow", "Gray", "White", "Pink", "Beige", "Navy"
    ]
    const sizes = ["XS", "S", "M", "L", "XL", "XXL"]
    const materials = ["Cotton", "Wool", "Denim", "Polyester", "Slick", "Linen", "Viscose", "Fleece"]
    const brands = [
        "Urban Threads", "Modern", "Street Style", "Beach Breeze", "Fashionista", "ChicStyle"
    ]
    ...
    return (
        <div className="p-4">
            ...
            {/* category Filter */}
            <div className="mb-6">
                <label className="block text-gray-600 font-medium mb-2">Categroy</label>
                {
