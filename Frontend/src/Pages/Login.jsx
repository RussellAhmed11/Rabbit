...
import loginImg from "../../public/assets/login.webp"
        ...
        <div className="flex">
            <div className="w-full md:w-1/2 flex flex-col justify-center items-center p-8 md:p-12">
                <form onSubmit={handleSubmit} className="w-full max-w-md bg-white p-8 rounded-lg border shadow-sm">
                    ...
                    <button type="submit" className="w-full bg-black text-white p-2 rounded-lg font-semibold hove:bg-gray-800 transition">Sign In</button>
                <p className="mt-6 text-center text-sm">Don't have account?<Link to="/register" className="text-blue-500 hover:underline transition">Register</Link></p>
                </form>
            </div>
